...
//		
		...
		//방법2
		int result = age1 - age2;              //정렬기준1 : 나이 오름차순
		int result2 = name1.compareTo(name2);  //정렬기준2 : 나이 내림차순
...
public class ComparatorEx {
	...
	public static void main(String[] args) {
		List<User> userList = Arrays.asList(
			...
			new User("Joeun1234", "김조은", 34),	
			new User("tje0924", "배조은", 34),	
