...
public class Academy {
	...
	public static void main(String[] args) {
		...
		//직장인 과정
		List<? super Worker> workerList = new ArrayList<Worker>();
		workerList.add(new Worker("김백수"));
		workerList.add(new Worker("안기옥"));
		...
		middleStudentCourse.createCourse("중학생과정", personCourse);
		
		//(에러) workerCourse.createWorkerCourse("직장인과정3, studentCourse);
