...
public class MathEx {
	...
	public static void main(String[] args) {
		System.out.println(Math.PI);   //3.141562... 원주율
		System.out.println(Math.E);    //2.7182818...자연상수
		...
		//Math.random()   : 0.0xxx~0.9xxxxxx
		//(0.0xxx~0.9xxx) * 10 : 0.0xxx~9.xxx   (0~9)  - 10개
		//(0.0xxx~0.9xxx) * 20 : 0.0xxx~19.xxx   (0~19)  - 20개
		//(0.0xxx~0.9xxx) * 30 : 0.0xxx~44.xxx   (0~44)  - 45개
		...
		//최댓값
		double[]arr = {0.22, 12.45, 33.22, 88.12, 70.45};
